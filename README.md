...
The translations in the ship's terminal, still have **some translations written by Chat GPT**. So, take the terminal translations with a grain of salt.

I am in the process of rewriting the terminal translations and will have a professional editor review them in the coming months.
...
> [Subtitles by JustJelly](https://thunderstore.io/c/lethal-company/p/JustJelly/Subtitles/) (Support momentarilly removed. I expect to re-add, rewritten by me instead of chat gpt with correct accents in February)
